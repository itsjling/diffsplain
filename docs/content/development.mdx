...
For dependency updates, main branch rules, the release push identity, and
admin recovery, see the [repository security runbook](https://github.com/itsjling/diffsplain/blob/main/docs/repository-security.md).
